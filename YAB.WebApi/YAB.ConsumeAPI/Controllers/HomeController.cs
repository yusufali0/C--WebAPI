...
using YAB.ConsumeAPI.ResponseModels;

namespace YAB.ConsumeAPI.Controllers
{
    public class HomeController : Controller
    {
        ...
        public async Task<IActionResult> Upload(IFormFile file)
        {
            ...
            //System.IO.File.ReadAllBytes(File.file) Kullanışlı bir yol değil dosya yolunu bulmada hata alınıyor
